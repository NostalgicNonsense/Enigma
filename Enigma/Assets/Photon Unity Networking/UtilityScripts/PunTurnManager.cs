...
namespace Photon_Unity_Networking.UtilityScripts
{
    ...
    public class PunTurnManager : PunBehaviour
    {
        ...
        /// </summary>
        private readonly HashSet<Plugins.PhotonNetwork.PhotonPlayer> finishedPlayers = new HashSet<Plugins.PhotonNetwork.PhotonPlayer>();
        ...
        public bool GetPlayerFinishedTurn(Plugins.PhotonNetwork.PhotonPlayer player)
        {
        ...
        {
            Plugins.PhotonNetwork.PhotonPlayer sender = Plugins.PhotonNetwork.PhotonPlayer.Find(senderId);
            switch (eventCode)
            {
                case EvMove:
                {
    ...
    public interface IPunTurnManagerCallbacks
    {
        ...
        void OnPlayerMove(Plugins.PhotonNetwork.PhotonPlayer player, int turn, object move);
        ...
        /// <param name="turn">Turn index</param>
        /// <param name="move">Move Object data</param>
        void OnPlayerFinished(Plugins.PhotonNetwork.PhotonPlayer player, int turn, object move);
    ...
    public static class TurnExtensions
    {
        ...
        /// <param name="player">Player reference</param>
        public static int GetFinishedTurn(this Plugins.PhotonNetwork.PhotonPlayer player)
        {
        ...
        /// <param name="player">Player Reference</param>
        /// <param name="turn">Turn Index</param>
        public static void SetFinishedTurn(this Plugins.PhotonNetwork.PhotonPlayer player, int turn)
        {
            Room room = PhotonNetwork.room;
            if (room == null || room.CustomProperties == null)
            {
