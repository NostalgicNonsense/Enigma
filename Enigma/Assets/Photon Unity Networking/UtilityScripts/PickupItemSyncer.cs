    ...
    public class PickupItemSyncer : MonoBehaviour
    {
        ...
        public void AskForPickupItemSpawnTimes()
        {
            if (this.IsWaitingForPickupInit)
            {
                ...
                Plugins.PhotonNetwork.PhotonPlayer nextPlayer = PhotonNetwork.masterClient.GetNext();
        ...
        private void SendPickedUpItems(Plugins.PhotonNetwork.PhotonPlayer targetPlayer)
        {
