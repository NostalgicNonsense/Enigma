...
namespace Photon_Unity_Networking.UtilityScripts
{
    ...
    public class PunTeams : MonoBehaviour
    {
        ...
        public static Dictionary<Team, List<Plugins.PhotonNetwork.PhotonPlayer>> PlayersPerTeam;
        ...
        public void Start()
        {
            PlayersPerTeam = new Dictionary<Team, List<Plugins.PhotonNetwork.PhotonPlayer>>();
            Array enumVals = Enum.GetValues(typeof (Team));
            foreach (var enumVal in enumVals)
            {
                PlayersPerTeam[(Team)enumVal] = new List<Plugins.PhotonNetwork.PhotonPlayer>();
            }
        }
        ...
        public void OnPhotonPlayerDisconnected(Plugins.PhotonNetwork.PhotonPlayer otherPlayer)
        {
            this.UpdateTeams();
        }

        public void OnPhotonPlayerConnected(Plugins.PhotonNetwork.PhotonPlayer newPlayer)
        {
            this.UpdateTeams();
        }
        ...
        public void UpdateTeams()
        {
            ...
            {
                Plugins.PhotonNetwork.PhotonPlayer player = PhotonNetwork.playerList[i];
    ...
    public static class TeamExtensions
    {
        ...
        public static PunTeams.Team GetTeam(this Plugins.PhotonNetwork.PhotonPlayer player)
        {
            object teamId;
        ...
        public static void SetTeam(this Plugins.PhotonNetwork.PhotonPlayer player, PunTeams.Team team)
        {
