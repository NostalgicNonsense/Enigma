...
namespace UFPS.Base.Scripts.GUI
{
    public class vp_PainHUD : MonoBehaviour
    {
        ...
        protected virtual void UpdatePainFlash()
        {
            ...
            if (UseOnGUI)
            {
                UnityEngine.GUI.color = m_PainColor;

                if (PainTexture != null)
                    UnityEngine.GUI.DrawTexture(new Rect(0, 0, Screen.width, Screen.height), PainTexture);
        ...
        protected virtual void UpdateInflictorArrows()
        {
            ...
            for (int v = m_Inflictors.Count - 1; v > -1; v--)
            {
                ...
                if (UseOnGUI)
                {
                    ...
                    UnityEngine.GUI.color = m_ArrowColor;
                    UnityEngine.GUI.DrawTexture(new Rect(pos.x, pos.y, scale, scale), ArrowTexture);
        ...
        protected virtual void UpdateDeathTexture()
        {
            ...
            if (UseOnGUI)
            {
                ...
                UnityEngine.GUI.color = m_SplatColor;
                UnityEngine.GUI.DrawTexture(m_SplatRect, DeathTexture);
            }
