...
namespace UFPS.Base.Scripts.GUI
{
    public class vp_SimpleHUD : MonoBehaviour
    {
        ...
        void DrawText()
        {
            ...
            UnityEngine.GUI.color = m_MessageColor;
            UnityEngine.GUI.Box(new Rect(200, 150, Screen.width - 400, Screen.height - 400), m_PickupMessage, MessageStyle);
            UnityEngine.GUI.color = Color.white;
        ...
        void DrawLabel(string text, Vector2 position, Vector2 scale, GUIStyle textStyle, Color textColor, Color bgColor, Texture texture)
        {
            ...
            if (bgColor != Color.clear)
            {
                ...
                if (texture != null)
                    UnityEngine.GUI.DrawTexture(m_DrawLabelRect, texture);
            }

            UnityEngine.GUI.color = textColor;
            UnityEngine.GUI.Label(m_DrawLabelRect, text, textStyle);
            UnityEngine.GUI.color = Color.white;
