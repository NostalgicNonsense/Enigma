...
namespace UFPS.Base.Scripts.Core.Attributes
{
    public static class vp_PropertyDrawerUtility
    {
        ...
        static Rect ItemField(Rect pos, string label, object targetObject, Texture2D icon)
        {
            ...
            if (UnityEngine.GUI.Button(pos, label, ItemStyle) && (targetObject != null) && (targetObject is Object))
        ...
        static Rect ValueField(Rect pos, ref int value, string name, System.Action action, float extraSize = 0, System.Action deleteAction = null)
        {
            ...
            UnityEngine.GUI.color = new Color(0.85f, 0.85f, 0.85f, 1);
            if (value != -1)
                UnityEngine.GUI.Label(pos, name, ValueStyle);
            ...
            if (deleteAction != null)
            {
                ...
                d.y += 3;
                d.x += 3;
                if (UnityEngine.GUI.Button(d, "X", SmallButtonStyle) && (deleteAction != null))
                    deleteAction.Invoke();
                d.x -= 3;
                d.y -= 3;
            }
        ...
        public static Rect DeleteButton(Rect pos, System.Action deleteAction)
        {
            ...
            pos.width = 21;
            pos.height = 21;
            UnityEngine.GUI.Label(pos, "", ValueStyle);
            pos.y += 3;
            pos.x += 3;
            if (UnityEngine.GUI.Button(pos, "X", SmallButtonStyle) && (deleteAction != null))
                deleteAction.Invoke();
            pos.x -= 3;
            pos.y -= 3;
            return pos;
        ...
        public static Object AddObjectBox(Rect pos, string objectTypeName, System.Type type, System.Action<Object> dragAction, float width = 208)
        {
            ...
            py.x += 10;
            py.y += 10;
            UnityEngine.GUI.Label(py, "Drag a" + objectTypeName + " object here.", ObjectFieldStyle);
        ...
        public static void AddObjectBoxBG(Rect pos, float width = 208)
        {
            ...
            pos.height = 35;
            pos.width = width + 15;
            UnityEngine.GUI.Label(pos, "", FieldStyle);
        ...
        public static void HelpBox(Rect pos, string message, MessageType type, string manualURL = null)
        {
            ...
            // draw text box
            UnityEngine.GUI.TextArea(pos, message, ((type != MessageType.None) ? vp_PropertyDrawerUtility.HelpboxIconTextBoxStyle : vp_PropertyDrawerUtility.HelpboxTextBoxStyle));
            ...
            UnityEngine.GUI.Label(m_IconPosition, GUIContent.none, m_HelpboxIconStyle);
            ...
            {
                UnityEngine.GUI.color = Color.clear;
                if (UnityEngine.GUI.Button(pos, new GUIContent("", "Double-click for more help")))
                {
        ...
        public static void Separator(Rect pos)
        {
            ...
            UnityEngine.GUI.color = new Color(1, 1, 1, 0.25f);
            pos.x += 4;
            pos.width -= 8;
            UnityEngine.GUI.Box(pos, GUIContent.none, "HorizontalSlider");
            UnityEngine.GUI.color = Color.white;
