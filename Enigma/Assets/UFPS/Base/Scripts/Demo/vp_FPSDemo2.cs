...
namespace UFPS.Base.Scripts.Demo
{
    public class vp_FPSDemo2 : MonoBehaviour
    {
        ...
        void DemoPhysics()
        {
            ...
            {
                UnityEngine.GUI.color = new Color(1, 1, 1, m_GoAgainButtonAlpha);
                m_GoAgainButtonAlpha = Mathf.Lerp(0, 1, m_GoAgainButtonAlpha + (Time.deltaTime));
                if (UnityEngine.GUI.Button(new Rect((Screen.width / 2) - 60, 210, 120, 30), "Go again!"))
                {
                    m_GoAgainButtonAlpha = 0.0f;
                    m_ExamplesCurrentSel = -1;
                }
                UnityEngine.GUI.color = new Color(1, 1, 1, 1 * m_Demo.GlobalAlpha);
            }
            ...
            switch (m_Demo.ButtonSelection)
            {
                ...
                case 3:
                    ...
                    {
                        UnityEngine.GUI.color = new Color(1, 1, 1, ((m_Demo.ClosingDown) ? m_Demo.GlobalAlpha : 1.0f));
                        UnityEngine.GUI.Label(new Rect((Screen.width / 2) - 200, 140, 400, 20), "(Press ENTER to reenable menu)", m_Demo.CenterStyle);
                        UnityEngine.GUI.color = new Color(0, 0, 0, 1 * (1.0f- ((Time.time - m_WASDInfoClickTime) * 0.05f)));
                        UnityEngine.GUI.Label(new Rect((Screen.width / 2) - 200, 170, 400, 20), "(Use WASD to move around freely)", m_Demo.CenterStyle);
                        UnityEngine.GUI.color = new Color(1, 1, 1, 1 * m_Demo.GlobalAlpha);
                    }
                    break;
            }
